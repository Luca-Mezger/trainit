...
# test sgd optimizer
#python train_jax.py logging.wandb_project=luca_hints logging.wandb_name=adam
python train_jax.py logging.wandb_project=luca_hints logging.wandb_name=adam_wd0 optimizer.lr_config.lr=0.0001
